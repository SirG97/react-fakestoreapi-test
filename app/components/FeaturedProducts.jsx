                        ...
                        <div className="relative w-64 h-64 max-w-xs overflow-hidden rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
                            ...
                            <div className="px-1 pb-1 w-full absolute bottom-0 backdrop-brightness-50">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="text-white bg-pink-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
